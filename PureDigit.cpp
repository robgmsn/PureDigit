...
int Digits[]={digitA ,digitB,digitC,digitD,digitE,digitF,digitG};
bool PureDigit::getSwitchState() {
        bool swState = !digitalRead(sw);
        return swState;
}

void PureDigit::displayRandom(){
int Digits[]={digitA ,digitB,digitC,digitD,digitE,digitF,digitG, digitDP};
for (int i=0;i<4;i++){
   int digit=random(0,8);
